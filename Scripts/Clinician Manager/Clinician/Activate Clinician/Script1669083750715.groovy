...
WebUI.verifyElementText(findTestObject('Clinician Manager/Clinician/Search/TBRecord1_Status'), 'Deactivated')
...
WebUI.click(findTestObject('Clinician Manager/Clinician/Activate-Deactivate/button_Activate'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('Clinician Manager/Clinician/Activate-Deactivate/label_Activate'), 0)

WebUI.verifyElementText(findTestObject('Clinician Manager/Clinician/Activate-Deactivate/label_Activate'), 'ACTIVATE USER')

WebUI.click(findTestObject('Clinician Manager/Clinician/Activate-Deactivate/button_ActivateConfirm'), FailureHandling.STOP_ON_FAILURE)
