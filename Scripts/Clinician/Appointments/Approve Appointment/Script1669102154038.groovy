...
if (WebUI.verifyElementVisible(findTestObject('Clinician/Appointments/Pending/TBRecord1'), FailureHandling.OPTIONAL)) {
    ...
    WebUI.click(findTestObject('Clinician/Appointments/Pending/TBRecord1_Approve'), FailureHandling.STOP_ON_FAILURE)

    WebUI.waitForElementVisible(findTestObject('Clinician/Appointments/Pending/modal_Approve'), 0)

    WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

    WebUI.click(findTestObject('Clinician/Appointments/Pending/button_ApproveOk'), FailureHandling.STOP_ON_FAILURE)
