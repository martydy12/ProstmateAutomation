...
if (WebUI.verifyElementVisible(findTestObject('Clinician/Appointments/Today/label_NoRecord'), FailureHandling.OPTIONAL)) {
    ...
    WebUI.verifyElementText(findTestObject('Clinician/Appointments/Pending/label_status'), 'ACCEPTED')

    WebUI.comment('Add Note')

    WebUI.setText(findTestObject('Clinician/Appointments/Today/textarea_Note'), 'Appointment was Accepted')

    WebUI.scrollToElement(findTestObject('Clinician/Appointments/Today/button_Save'), 0)

    WebUI.click(findTestObject('Clinician/Appointments/Today/button_Save'), FailureHandling.STOP_ON_FAILURE)
