...
if (WebUI.verifyElementVisible(findTestObject('Booking Manager/Appointments/Pending/TBRecord1'), FailureHandling.OPTIONAL)) {
    ...
    WebUI.click(findTestObject('Booking Manager/Appointments/Pending/TBRecord1_Decline'), FailureHandling.STOP_ON_FAILURE)

    WebUI.waitForElementVisible(findTestObject('Booking Manager/Appointments/Pending/modal_Decline'), 0)

    WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

    WebUI.click(findTestObject('Booking Manager/Appointments/Pending/button_DeclineNo'), FailureHandling.STOP_ON_FAILURE)
    ...
    WebUI.setText(findTestObject('Booking Manager/Appointments/Pending/textarea_DeclinedComment'), 'Doctor is out sick today. Please request again.')

    WebUI.click(findTestObject('Booking Manager/Appointments/Pending/button_DeclineYes'), FailureHandling.STOP_ON_FAILURE)
