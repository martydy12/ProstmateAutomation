...
WebUI.click(findTestObject('Admin/Activate-Deactivate/button_Deactivate'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('Admin/Activate-Deactivate/label_Deactivate'), 0)

WebUI.verifyElementText(findTestObject('Admin/Activate-Deactivate/label_Deactivate'), 'DEACTIVATE ADMIN')

WebUI.click(findTestObject('Admin/Activate-Deactivate/button_DeactivateConfirm'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.scrollToElement(findTestObject('Admin/Activate-Deactivate/button_Activate'), 0)
